                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-md-12 ">
                                        <a class="btn btn-success" href="DeptoController?accion=add">
                                    ...
                                    <div id="listadoregistros">
                                        <table id="tbllistado" class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td><%= de.getNombre()%></td>
                                                <td>
                                                    <a href="DeptoController?accion=editar&IdDepartamento=<%= de.getIdDepartamento()%>" class="btn btn-warning">Editar</a>
                                                    <a onclick="return confirm('Esta seguro?');" href="DeptoController?accion=eliminar&IdDepartamento=<%= de.getIdDepartamento()%>" class="btn btn-danger">Eiminar</a>
                                                </td>
                                            </tr>
                                            <% }%>
                                    </table>
