                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-md-12 ">
                                        <a class="btn btn-success" href="MaterialController?accion=add">
                                    ...
                                    <div id="listadoregistros">
                                        <table id="tbllistado" class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="MaterialController?accion=editar&IdMaterial=<%= m.getIdMaterial()%>" class="btn btn-warning">Editar</a>
                                                    <a onclick="return confirm('Esta seguro?');" href="MaterialController?accion=eliminar&IdMaterial=<%= m.getIdMaterial()%>" class="btn btn-danger">Eiminar</a>
                                                </td>
                                            </tr>
                                            <% }%>
                                        </table>
