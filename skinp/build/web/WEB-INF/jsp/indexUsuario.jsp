<%-- 
    ...
    Created on : 18/07/2019, 02:21:13 PM
    Author     : angel
--%>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row justify-content-end">
                <div class="col-md-12 ">
                  <a class="btn btn-success" href="agregarUsuario.htm">
              ...
              <table class="table table-hover">
                ...
                <c:forEach var="dato" items="${lista}">
                    <tr>                      
                        ...
                        <td>${dato.Estado}</td>
                        <td>
                            <a href="editarUsuario.htm?IdUser=${dato.IdUser}" class="btn btn-warning">Editar</a>
                            <a onclick="return confirm('Esta seguro?');" href=" deleteUsuario.htm?IdUser=${dato.IdUser}" class="btn btn-danger">Eiminar</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
