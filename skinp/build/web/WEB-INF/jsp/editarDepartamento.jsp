...
<%@page import="ModeloDAO.DeptoDAO"%>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body px-lg-5 pt-5">
                                            <%
                                                ...
                                                int IdDepartamento = Integer.parseInt((String) request.getAttribute("Id"));
                                                Departamento de = (Departamento) dao.list(IdDepartamento);
                                            %>
                                            <form class="mb-3 pb-1" name="formulario" id="formulario" action="DepartamentoController" >

                                                <div class="form-group col-sm-12 col-md-6 col-xl-12">
                                                    <label>Nombre</label>

                                                    <input type="text" class="form-control" name="Nombre" id="Nombre" maxlength="50"  value="<%= de.getNombre()%>" >
                                                    <input type="hidden" name="IdDepartamento" value="<%= de.getIdDepartamento()%>">
                                                </div>
                                                ...
                                                <button class="btn btn-outline-success btn-block" type="submit" value="Actualizar"><i class="fa fa-save"></i>
                                                    Guardar</button>
                                                <a class="btn btn-outline-danger btn-block" href="DeptoController?accion=listar"><i
