                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row justify-content-">
                                    <div class="col-md-12 ">
                                        <a class="btn btn-success" href="SerieController?accion=add">
                                    ...
                                    <table id="tbllistado" class="table table-striped">
                                        ...
                                        %>
                                            ...
                                            <tr>
                                                <td><%= se.getNombre()%></td>
                                                <td>
                                                    <a href="SerieController?accion=editar&IdSerie=<%= se.getIdSerie()%>" class="btn btn-warning">Editar</a>
                                                    <a onclick="return confirm('Esta seguro?');" href="SerieController?accion=eliminar&IdSerie=<%= se.getIdSerie()%>" class="btn btn-danger">Eiminar</a>
                                                </td>
                                            </tr>
                                            <% }%>
                                    </table>
