<%-- 
    ...
    Created on : 18/07/2019, 02:20:43 PM
    Author     : angel
--%>
                ...
                <div class="card">
                  ...
                  <div class="card-body px-lg-5 pt-5">
                    ...
                    <form class="mb-3 pb-1" name="formulario" id="formulario" method="POST">
                      ...
                      <select class="browser-default custom-select mb-4" name="IdCiudad" id="IdCategoria">                       
                            <c:forEach var="dato" items="${lista}">
                            <option value="${dato.IdCiudad}">${dato.Nombre} </option>
                            </c:forEach>
                        </select>
                      ...
                      <label for="nombre">Nombres</label>
                       <input type="text" name="Nombres" id="nombre" class="form-control" placeholder="" >
                        
                        <label for="nombre">Apellidos</label>
                        <input type="text" name="Apellidos" id="nombre" class="form-control" ">
                        
                        <label for="nombre">Documento</label>
                        <input type="text" name="Documento" id="nombre" class="form-control" placeholder="" >
                        ...
                        <input type="Email" name="nombre" id="nombre" class="form-control" placeholder="" >
                        
                        <label for="nombre">Contraseña</label>
                        <input type="password" name="Contrasena" id="nombre" class="form-control" placeholder="" ">
