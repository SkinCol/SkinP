<%-- 
    Document   : agregarFacInsumos
    Created on : 27/06/2019, 05:18:18 PM
    Author     : angel
--%>
              ...
              <div class="panel-body" id="formularioregistros">
                <div class="card">
                  ...
                  <h5 class="card-header info-color white-text text-center py-4">
                    <strong>Agregar Factura Insumos</strong>
                  </h5>
                  ...
                  <div class="card-body px-lg-5 pt-5">
                    ...
                    <form class="mb-3 pb-1" name="formulario" id="formulario" method="POST">
                      ...
                      <select class="browser-default custom-select mb-4" name="IdProveedor" id="IdProveedor">                       
                            ...
                            <option value="${dato.IdProveedor}">${dato.Nombre} </option>
                            </c:forEach>
                        </select>
                      ...
                      <select class="browser-default custom-select mb-4" name="IdMaterial" id="IdMaterial">                       
                            ...
                            <option value="${dato.IdMaterial}">${dato.Nombre} </option>
                            </c:forEach>
                        </select>
                      ...
                      <label for="nombre">Cantidad</label>
                        ...
                        <input type="number" name="Costo" id="Costo" class="form-control" placeholder="">
