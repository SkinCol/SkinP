<%-- 
    Document   : editarFacInsumos
    Created on : 27/06/2019, 05:18:39 PM
    Author     : angel
--%>
              ...
              <div class="panel-body" id="formularioregistros">
                <div class="card">
                  ...
                  <h5 class="card-header info-color white-text text-center py-4">
                    <strong>Editar Factura Insumos</strong>
                  </h5>
                  ...
                  <div class="card-body px-lg-5 pt-5">
                    ...
                    <form class="mb-3 pb-1" name="formulario" id="formulario" method="POST">
                      ...
                      <label for="select">Proveedor</label>
                        <select class="browser-default custom-select mb-4" name="IdProveedor" id="IdProveedor">
                            <c:forEach var="dato" items="${listaP}">
                                <c:if test="${dato.IdFacturaInsumos != lista[0].IdProveedor}">
                      ...
                      <label>Material</label>
                        <select class="browser-default custom-select mb-4" name="IdMaterial" id="IdMaterial">
                            <c:forEach var="dato" items="${listaM}">
                                <c:if test="${dato.IdFacturaInsumos != lista[0].IdMaterial}">
                                    <option value="${dato.IdMaterial}">
                                        ${dato.Nombre}
                                    </option>
                                </c:if>
                                    <c:if test="${dato.IdFacturaInsumos == lista[0].IdMaterial}">
                                        <option value="${dato.IdMaterial}" selected="true">
                                        ${dato.Nombre}
                                        </option>                                                                          
                                </c:if>
                            </c:forEach>
                      ...
                      <div class="form-group col-sm-12 col-md-6 col-xl-12">
                        ...
                        <input type="number" name="Cantidad" id="Cantidad" class="form-control" value="${lista[0].Cantidad}">
                      </div>
                      <div class="form-group col-sm-12 col-md-6 col-xl-12 ">
                        <label>Costo</label>
                        <input type="number" name="Costo" id="Costo" class="form-control" value="${lista[0].Costo}">
                      </div>

                      <hr>
                      <button class="btn btn-outline-success btn-block" type="submit" ><i class="fa fa-save"></i>
                        Guardar</button>
                      <a class="btn btn-outline-danger btn-block" href="indexFacInsumos.htm"><i
