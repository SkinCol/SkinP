<%-- 
    Document   : editarSkin
    Created on : 10/06/2019, 01:50:54 PM
    Author     : angel
--%>
                ...
                <div class="card">
                  ...
                  <div class="card-body px-lg-5 pt-5">
                    ...
                    <form class="mb-3 pb-1" name="formulario" id="formulario" method="POST">
                        ...
                        <input type="hidden" id="IdSkin" name="IdSkin">
                      ...
                      <select class="browser-default custom-select mb-4" name="IdCategoria" id="IdCategoria">
                            <c:forEach var="dato" items="${listaC}">
                                <c:if test="${dato.IdSkin != lista[0].IdCategoria}">
                                    <option value="${dato.IdCategoria}">
                                        ${dato.Nombre}
                                    </option>
                                </c:if>
                                    <c:if test="${dato.IdSkin == lista[0].IdCategoria}">
                                        <option value="${dato.IdCategoria}" selected="true">
                                        ${dato.nombre}
                                        </option>                                                                          
                                </c:if>
                            </c:forEach>
                      ...
                      <div class="input-group mb-4">
                        ...
                        <div class="custom-file">
                          ...
                          <label class="custom-file-label" for="fileInput">Seleccione una imagen</label>
                        </div>
                      </div>
