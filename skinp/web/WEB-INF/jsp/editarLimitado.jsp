...
<%@page import="Model.Limitado"%>
<%@page import="ModeloDAO.LimitadoDAO"%>
              ...
              <div class="panel-body" id="formularioregistros">
                <div class="card">
                  ...
                  <h5 class="card-header info-color white-text text-center py-4">
                    <strong>Agregar Limitado</strong>
                  </h5>
                  ...
                  <div class="card-body px-lg-5 pt-5">
                      ...
                      <%
                          ...
                          int IdLimitado=Integer.parseInt((String)request.getAttribute("Id"));
                          Limitado li=(Limitado)dao.list(IdLimitado);
                      %>

                    <form class="mb-3 pb-1" name="formulario" id="formulario" action="LimitadoController">

                      <label for="nombre">Nombre Categoria</label>
                      <input type="text" name="Nombre" id="nombre" class="form-control" placeholder="" value="<%= li.getNombre()%>">
                      <input type="hidden" name="IdLimitado" value="<%= li.getIdLimitado()%>">
                      
                      <input type="text" name="Nombre" id="nombre" class="form-control" placeholder="" value="<%= li.getImagen()%>">

                      <hr>
                      <button class="btn btn-outline-success btn-block" type="submit" value="Actualizar"><i class="fa fa-save"></i>
                        Guardar</button>
                      <a class="btn btn-outline-danger btn-block" href="LimitadoController?accion=listar"><i
