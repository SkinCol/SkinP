                ...
                <div class="card">
                  ...
                  <div class="card-body px-lg-5 pt-5">
                      ...
                      <%
                          ...
                          int IdDispositivo=Integer.parseInt((String)request.getAttribute("Id"));
                          Dispositivo dis=(Dispositivo)dao.list(IdDispositivo);
                      %>

                    <form class="mb-3 pb-1" name="formulario" id="formulario" action="DispositivoController">

                      <div class="form-group col-sm-12 col-md-6 col-xl-12">
                      <label>Modelo</label>
                      <input type="text" class="form-control" name="Modelo" id="Nombre" maxlength="50"  value="<%= dis.getModelo()%>">
                      <input type="hidden" name="IdDispositivo" value="<%= dis.getIdDispositivo()%>">
                  </div>
                  <div class="form-group col-sm-12 col-md-6 col-xl-12">
                      <label>Marca</label>
                      <input type="text" name="Marca" id="NIT" class="form-control" value="<%= dis.getMarca()%>">
                  </div>
                  <div class="form-group col-sm-12 col-md-6 col-xl-12">
                    <label>Tipo</label>
                    <input type="text" name="Tipo" id="Direccion" class="form-control" value="<%= dis.getTipo()%>">
                  </div>
                  <div class="form-group col-sm-12 col-md-6 col-xl-12">
                      <label>Imagen</label>
                      <input type="text" name="Imagen" id="Correo" class="form-control" value="<%= dis.getImagen()%>">
                  </div>
                  
                      <hr>
                      <button class="btn btn-outline-success btn-block" type="submit" value="Actualizar"><i class="fa fa-save"></i>
                        Guardar</button>
                      <a class="btn btn-outline-danger btn-block" href="DispositivoController?accion=listar"><i
