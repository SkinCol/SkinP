...
<%@page import="ModeloDAO.SerieDAO"%>
                ...
                <div class="card">
                  ...
                  <div class="card-body px-lg-5 pt-5">
                      ...
                      <%
                          ...
                          int IdSerie=Integer.parseInt((String)request.getAttribute("Id"));
                          Serie ser=(Serie)dao.list(IdSerie);
                      %>
                      
                      

                    <form class="mb-3 pb-1" name="formulario" id="formulario" action="SerieController">

                      <div class="form-group col-sm-12 col-md-6 col-xl-12">
                      <label>Nombre</label>
                      <input type="text" class="form-control" name="Nombre" id="Nombre" maxlength="50"  value="<%= ser.getNombre()%>">
                      <input type="hidden" name="IdSerie" value="<%= ser.getIdSerie()%>">
                  </div>
