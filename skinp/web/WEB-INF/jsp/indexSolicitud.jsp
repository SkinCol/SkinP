<%-- 
    Document   : indexSolSkin
    Created on : 18/07/2019, 06:34:10 PM
    Author     : angel
--%>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row justify-content-end">
                <div class="col-md-12 ">
                  <a class="btn btn-success" href="agregarSolicitud.htm">
                ...
                <div id="listadoregistros">
                  <table id="tbllistado" class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>${dato.Cliente}</td>
                        <td>${dato.Administrador}</td>
                        <td>${dato.CostoSkin}</td>
                        <td>
                            <a href="editarSolicitud.htm?IdSolicitud=${dato.IdSolicitud}" class="btn btn-warning">Editar</a>
                            <a onclick="return confirm ('Esta seguro?');" href="deleteSolicitud.htm?IdSolicitud=${dato.IdSolicitud}" class="btn btn-danger">Eiminar</a>
                        </td>
                    </tr>
                </c:forEach>
                  </tbody>
