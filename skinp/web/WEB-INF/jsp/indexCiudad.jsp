                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row justify-content-">
                                    <div class="col-md-12 ">
                                        <a class="btn btn-success" href="ControllerCiudad?accion=add">
                                ...
                                <div id="listadoregistros">
                                    <table id="tbllistado" class="table table-striped">
                                        ...
                                        <c:forEach var="dato" items="${departamento}">
                                            <tr>
                                                <td>${dato.IdCiudad}</td> 
                                                <td>${dato.getDepartamento()}</td>
                                                <td>${dato.getNombre()}</td>
                                                <td>
                                                    <a href="editarCiudad.htm?IdCiudad=${dato.IdCiudad}" class="btn btn-warning">Editar</a>
                                                    <a onclick="return confirm('Esta seguro?');" href="deleteCiudad.htm?IdCiudad=${dato.IdCiudad}" class="btn btn-danger">Eiminar</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </table>
