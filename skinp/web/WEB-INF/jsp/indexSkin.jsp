              ...
              <table class="table table-hover">
                ...
                <div id="listadoregistros">
                  <table id="tbllistado" class="table table-striped">
                    ...
                    <tbody>
                        <c:forEach var="s" items="listar" >
                            
                        
                    <tr>
                        <td>${s.getIdLimitado()}</td>
                        <td>${s.getImagen()}</td>
                        <td>${s.getImagenUsuario()}</td> 
                        <td>${s.getCostoSkin()}</td>
                        <td>${s.getDisponible()}</td>
                        <td>
                            <a href="editarSkin.htm?IdSkin=<%=li.getIdSkin()%>" class="btn btn-warning">Editar</a>
                            <a onclick="return confirm('Esta seguro?');" href=" deleteSkin.htm?IdSkin=<%=li.getIdSkin()%>" class="btn btn-danger">Eiminar</a>
                        </td>
                    </tr>
               </c:forEach>
            </tbody>
