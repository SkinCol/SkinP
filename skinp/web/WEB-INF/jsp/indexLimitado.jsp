                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-md-12 ">
                                        <a class="btn btn-success" href="LimitadoController?accion=add">
                                    ...
                                    <div id="listadoregistros">
                                        <table id="tbllistado" class="table table-striped">
                                            ...
                                            <%
                                                ...
                                                List<Limitado> list = dao.listar();
                                                Iterator<Limitado> iter = list.iterator();
                                                Limitado li = null;
                                            ...
                                            %>  
                                            <tr>
                                                <td><%= li.getIdLimitado()%></td> 
                                                <td><%= li.getNombre()%></td>
                                                <td><%= li.getImagen()%></td>
                                                <td>
                                                    <a href="LimitadoController?accion=editar&IdLimitado=<%= li.getIdLimitado()%>" class="btn btn-warning">Editar</a>
                                                    <a onclick="return confirm('Esta seguro?');" href="LimitadoController?accion=eliminar&IdLimitado=<%= li.getIdLimitado()%>" class="btn btn-danger">Eiminar</a>
                                                </td>
                                            </tr>
                                            <%}%>
