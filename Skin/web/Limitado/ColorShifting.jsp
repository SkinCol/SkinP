<%-- 
    Document   : ColorShifting
    Created on : 03-sep-2019, 16:55:48
    Author     : aleja
--%>
            ...
            <div class="container-fluid pl-5 pr-5">
                ...
                <div class="row wow fadeIn">
                    ...
                    <div class="col-md-6 mb-1">
                        ...
                        <!--Content-->
                        <div class="p-4">
                            <h1 class="h1-responsive font-weight-bold">Venom Series</h1>
                            <p class="lead">
                                <span class="mr-1">
                                    $100
                                </span>
                            ...
                            <ul>
                                ...
                                <li>Solo parte trasera</li>
                            </ul>

                            <form>
                                <input type="hidden" name="IdLimitado" value="1">
                                <!-- Default input -->
                                *Selecione Dispositivo
                                <div class="form-group">
                                    <select class="custom-select col-sm-12 col-md-6" name="IdDispositivo">
                                        <option selected>- Por favor selecione -</option>
                                        <c:forEach var="ph" items="${phone}">
                                            <option value="${ph.getIdDispositivo()}">${ph.getModelo()}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                *Cantidad
                                ...
                                <button type="submit" class="btn btn-light-green btn-lg btn-block col-sm-12 col-md-6">
                ...
                <div class="row d-flex justify-content-center wow fadeIn">
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <p class="text-justify">SkinCol presenta su nuevo skin de Edición Limitada, Venom. ¿Listo para ser el anfitrión del simbionte más popular de la ciudad? Una vez que Venom obtenga sus zarcillos en su teléfono, será difícil dejarlo ir. 
                            Disponible solo en la parte posterior, esta elegante piel negra orgánica se vuelve suave y protege las superficies subyacentes de muescas y rasguños.</p>
                    </div>
                    <!--Grid column-->
                </div>
                <!--Grid row-->
                ...
                <div class="my-custom-scrollbar my-custom-scrollbar-primary">
                    <img class="img-fluid" src="https://res.cloudinary.com/skincol-me/image/upload/v1566570011/Limited/Venom%20Series/Note9-Venom-Slider_bxwggw.jpg">
                    <img class="img-fluid" src="https://res.cloudinary.com/skincol-me/image/upload/v1566570091/Limited/Venom%20Series/iPhone-X-Image-3-Venom-Slider_q17ftd.jpg">
                    <img class="img-fluid" src="https://res.cloudinary.com/skincol-me/image/upload/v1566570116/Limited/Venom%20Series/venom2_bbq6ka.jpg">
                    <img class="img-fluid" src="https://res.cloudinary.com/skincol-me/image/upload/v1566570147/Limited/Venom%20Series/iPhone-X-Image-1-Venom-Slider_dwwnx9.jpg">
                    <img class="img-fluid" src="https://res.cloudinary.com/skincol-me/image/upload/v1566570171/Limited/Venom%20Series/iPhone-X-Image-2-Venom-Slider_fhmuwn.jpg">
                    <img class="img-fluid" src="https://res.cloudinary.com/skincol-me/image/upload/v1566570207/Limited/Venom%20Series/venom1_xvxrru.jpg">
                </div>
                <!-- Grid row -->
            </div>
        </main>
