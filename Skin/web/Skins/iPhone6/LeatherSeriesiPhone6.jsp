<%-- 
    Document   : LeatherSeriesiPhone6
    Created on : 6/09/2019, 09:49:09 AM
    Author     : alejandro
--%>
    ...
    <body>
        ...
        <main class="mt-5 pt-4">
            <div class="container-fluid pl-5 pr-5">
                ...
                <!--Content-->
                <div class="p-4">
                    <h1 class="h1-responsive font-weight-bold">PIEL SERIES SKINS/WRAPS FOR IPHONE 6</h1>
                    <ul>
                            ...
                            <div class="col-lg-4 col-md-12">
                                ...
                                <div class="card card-cascade wider mb-3">
                                    ...
                                    <div class="view view-cascade">
                                        <img src="${t.getImagen()}" class="card-img-top">
                                        <a href="#!">
                                    ...
                                    <div class="card-body card-body-cascade text-center">
                                        <!--Title-->
                                        <h4 class="card-title"><strong>${t.getNombre()}</strong></h4>
                                        <hr>
                                        <p class="lead">
                                            <span class="mr-1">
                                                $ ${t.getCostoSkin()}
                                        ...
                                        <a href="ControllerSkin?accion=AgregarCarrito&Id=${me.getIdSkin()}" class="btn btn-light-green">
