<%-- 
    Document   : Tabletas
    Created on : 03-sep-2019, 17:02:45
    Author     : aleja
--%>
...
<html>
    <head>
        ...
        <title>Dispositivos - Tabletas</title>
    </head>
    <body>
        <!-- Navbar -->
        ...
        <main class="mt-5 pt-4">
            ...
            <div class="container">
                ...
                <h1 class="my-5 display-4 text-left">Tabletas</h1>

                <!--Grid row-->
                <div class="row text-center wow fadeIn">

                    <!--Grid column 1-->
                    <c:forEach var="t" items="${tablet}">
                        <div class="col-lg-3 col-md-6 mb-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="">
                                        <img src="${t.getImagen()}" style="height: 200px; width: 200px;" class="mb-2">
                                    </a>
                                </div>
