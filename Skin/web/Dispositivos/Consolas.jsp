<%-- 
    Document   : Consolas
    Created on : 03-sep-2019, 17:03:13
    Author     : aleja
--%>
...
<html>
    <head>
        ...
        <title>Dispositivos - Consolas</title>
    </head>
    <body>
        <!-- Navbar -->
        ...
        <main class="mt-5 pt-4">
                    ...
                    <c:forEach var="xb" items="${xbox}">
                        <div class="col-lg-3 col-md-6 mb-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="">
                                        <img src="${xb.getImagen()}" style="height: 200px; width: 200px;" class="mb-2">
                                    </a>
                                </div>
            ...
            <div class="container">
                ...
                <h1 class="my-5 display-4 text-left">PlayStation</h1>

                <!--Grid row-->
                <div class="row text-center wow fadeIn">

                    <!--Grid column 1-->
                    <c:forEach var="ps" items="${playstation}">
                        <div class="col-lg-3 col-md-6 mb-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="">
                                        <img src="${ps.getImagen()}" style="height: 200px; width: 200px;" class="mb-2">
                                    </a>
                                </div>
                                <div class="card-footer">
                                    <h5 class="entry-title p-1">
            ...
            <div class="container">
                ...
                <h1 class="my-5 display-4 text-left">Nintendo</h1>

                <!--Grid row-->
                <div class="row text-center wow fadeIn">

                    <!--Grid column 1-->
                    <c:forEach var="n" items="${nitendo}">
                        <div class="col-lg-3 col-md-6 mb-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="">
                                        <img src="${n.getImagen()}" style="height: 200px; width: 200px;" class="mb-2">
                                    </a>
                                </div>
                                <div class="card-footer">
                                    <h5 class="entry-title p-1">
